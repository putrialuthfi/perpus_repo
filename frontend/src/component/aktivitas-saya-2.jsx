        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <Breadcrumbs className="breadcrumbs-font">
                <a href="aktivitas-saya.jsx" className="opacity-60">
                  Sedang Dibaca
                </a>
                <a href="aktivitas-saya-2.jsx" className="">Selesai Dibaca</a>
            </Breadcrumbs>
            {/* section tabel */}
            <div className="mt-2">
            <table className="border w-full">
                ...
                <tbody className="text-left">
                    <tr>
                        ...
                        <td>B8761</td>
                        <td>12/12/2023</td>
                        <td className="inline-flex space-x-1">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#27A37F"><path d="m424-296 282-282-56-56-226 226-114-114-56 56 170 170Zm56 216q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Z"/></svg>
                    ...
                    <tr>
                        ...
                        <td>12/12/2023</td>
                        <td className="inline-flex space-x-1">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#E05151"><path d="m336-280 144-144 144 144 56-56-144-144 144-144-56-56-144 144-144-144-56 56 144 144-144 144 56 56ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Z"/></svg>
